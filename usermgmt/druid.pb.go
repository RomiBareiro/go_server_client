...
var file_proto_druid_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x64, 0x72, 0x75, 0x69, 0x64, 0x22, 0x30, 0x0a, 0x12, 0x41, 0x63,
	...
	0x64, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x10, 0x2e, 0x64, 0x72, 0x75, 0x69, 0x64, 0x2e, 0x44,
	0x72, 0x75, 0x69, 0x64, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x19, 0x2e, 0x64, 0x72, 0x75, 0x69, 0x64,
...
var file_proto_druid_proto_goTypes = []interface{}{
	(*AcknowlegeResponse)(nil), // 0: druid.AcknowlegeResponse
	(*DruidData)(nil),          // 1: druid.DruidData
}
var file_proto_druid_proto_depIdxs = []int32{
	1, // 0: druid.DruidManagement.SendDruidQuery:input_type -> druid.DruidData
	0, // 1: druid.DruidManagement.SendDruidQuery:output_type -> druid.AcknowlegeResponse
...
func (c *druidManagementClient) SendDruidQuery(ctx context.Context, in *DruidData, opts ...grpc.CallOption) (*AcknowlegeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/druid.DruidManagement/SendDruidQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DruidManagement_SendDruidQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/druid.DruidManagement/SendDruidQuery",
	}
...
var _DruidManagement_serviceDesc = grpc.ServiceDesc{
	ServiceName: "druid.DruidManagement",
